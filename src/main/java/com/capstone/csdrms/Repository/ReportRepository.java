...
public interface ReportRepository  extends JpaRepository<ReportEntity, Long> {
	...
	@Query("SELECT r FROM ReportEntity r WHERE (r.student.grade = :grade AND r.student.section = :section AND r.student.schoolYear = :schoolYear) OR r.complainant = :complainant")
	...
	List<ReportEntity> findAllByStudent_GradeAndStudent_SectionAndStudent_SchoolYearAndViewedByAdviserFalse(int grade, String section, String schoolYear);
